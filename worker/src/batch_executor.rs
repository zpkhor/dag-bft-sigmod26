...
const BUSY_SPINS: u64 = 50000;
// 52500 129k tps tuned for cloudlab xl170; BASELINE=1 NEW_SCHEDULER=0 E_SKEW_WEIGHTS=1,1,1 NO_SEND_PAYMENT=1 NUM_EXECUTORS=3 NODES=4 RATE_WEIGHTS=1,1,1,1 RATE=135000 DURATION=120 WARMUP=20 IN_MEMORY_STORE=1 fab cloudlab --latency=100ms --primary-bw=300mbit --worker-bw=600mbit
    ...
    async fn execute_migrate_out(
        ...
        if tx_header.tx_type == SAMPLE_TX_TYPE {
            info!(
                ...
                tx_header.id.tx_counter, tx_header.id.region_id, batch_digest
            );
        }
