...
CONFIGS=(
    # (d) varying nodes: imb60, 110k, balanced BW  (use longer duration as different run)
    "n21_v_rate_imb60|$(make_bw 21 '')|$(make_rate_imb_weights 21 0.6)|21|110000"
    "n16_v_rate_imb60|$(make_bw 16 '')|$(make_rate_imb_weights 16 0.6)|16|110000"
    "n10_v_rate_imb60|$(make_bw 10 '')|$(make_rate_imb_weights 10 0.6)|10|110000"
)
