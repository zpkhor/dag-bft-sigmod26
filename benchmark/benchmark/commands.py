...
class CommandMaker:
    ...
    @staticmethod
    def run_client(addresses, size, rate, nodes, account_start=None, num_accounts=None, reply_port=None, num_validators=None):
        ...
        return f'./benchmark_client {" ".join(addresses)} --size {size} --rate {rate} {nodes} {account_args}'
