...
class CommandMaker:
    ...
    @staticmethod
    def run_client(address, size, rate, nodes, open_loop=False, account_start=None, num_accounts=None):
        ...
        return f'./benchmark_client {address} --size {size} --rate {rate} {nodes} {open_loop_flag} {account_args}'
