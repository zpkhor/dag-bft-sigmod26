...
pub enum PrimaryWorkerMessage {
    ...
    CommittedBatches(Round, Vec<Digest>),
...
pub enum WorkerPrimaryMessage {
    ...
    OurBatch(Digest, WorkerId, HashMap<u32, u16>, u64),
    /// The worker indicates it received a batch's digest from another authority.
    OthersBatch(Digest, WorkerId, HashMap<u32, u16>),
}
...
impl Primary {
    pub fn spawn(
        ...
        let (tx_our_digests, rx_our_digests): (Sender<(Digest, WorkerId, HashMap<u32, u16>, u64)>, _) = channel(CHANNEL_CAPACITY);
...
struct WorkerReceiverHandler {
    tx_our_digests: Sender<(Digest, WorkerId, HashMap<u32, u16>, u64)>,
    tx_others_digests: Sender<(Digest, WorkerId, HashMap<u32, u16>)>,
}
